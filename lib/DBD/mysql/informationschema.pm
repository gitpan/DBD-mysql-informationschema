...
package DBD::mysql::informationschema;
...
DBD::mysql::informationschema - Perl module to access the mysql INFORMATION_SCHEMA view, which contains database metadata.

=head1 SYNOPSIS

     use DBD::mysql::informationschema;


Get a new infoschema object.

     my $info_schema = new DBD::mysql::informationschema ;
